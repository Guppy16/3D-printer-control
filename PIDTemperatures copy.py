...
com = "COM6"  # Change this to the COM port identified in Pronterface
...
maxtimesteps = 210  # i.e. 105 seconds
...
ser.write(f"M104 S{init_target}\r\n".encode())
# ser.write(b'M104 S' + str(init_target).encode() + b'\r\n')
time.sleep(2)
ser.write(f"M301 P{init_kp} I{init_ki} D{init_kd}\r\n".encode())
...
np.save(figname + '_temp', nozzle_data)
np.save(figname + '_targets', targets)
np.save(figname + '_times', t)
